...
case 'heal':
 if (!isCekDarah < 1) return reply('𝙺𝚊𝚖𝚞 𝚋𝚒𝚜𝚊 𝙷𝚎𝚊𝚕 𝚔𝚎𝚝𝚒𝚔𝚊 𝚍𝚊𝚛𝚊𝚑 𝚔𝚊𝚖𝚞  0')
 if (isCekDarah > 100) return reply('Darah kamu sudah penuh')
 if (isPotion < 1) return reply('𝙺𝚊𝚖𝚞 𝚃𝚒𝚍𝚊𝚔 𝙿𝚘𝚝𝚒𝚘𝚗,  𝚂𝚒𝚕𝚊𝚔𝚊𝚗 𝚐𝚞𝚗𝚊𝚔𝚊𝚗 .𝚋𝚞𝚢𝚙𝚘𝚝𝚒𝚘𝚗 _𝚓𝚞𝚖𝚕𝚊𝚑_') 
 addDarah(sender, 100)
 kurangPotion(sender, 1)
 reply('𝙳𝚊𝚛𝚊𝚑 𝙼𝚞 𝚜𝚞𝚍𝚊𝚑 𝙵𝚞𝚕𝚕')
 break   
 ...
 addPotion(sender,potjml)
 done = `۞ 𝙱𝙴𝙻𝙸 𝙿𝙾𝚃𝙸𝙾𝙽 ۞\n`
 done += `ᑀ 𝙿𝚎𝚖𝚋𝚎𝚕𝚒 : ${pushname}\n`
 done += `ᑀ 𝚂𝚝𝚊𝚝𝚞𝚜   : 𝚂𝚞𝚌𝚌𝚎𝚜\n`
 done += `ᑀ 𝙿𝚘𝚝𝚒𝚘𝚗  : ${getPotion(sender)}\n`
 ...
 setTimeout( () => { 
  ...
  sendButLocation(from, done, `𝙿𝚘𝚝𝚒𝚘𝚗  𝚃𝚛𝚊𝚗𝚜𝚊𝚔𝚜𝚒 ${botName}`, ptn, but, {quoted: mek})
  }, 2000) 
 break
